...
bool MainWindow::setupConnections() {
    ...
    connect(mSampleList, SIGNAL(itemClicked(QListWidgetItem*)), this, SLOT(checkPlugin(QListWidgetItem*)));
    ...
    // Populate samples.
    connect(mPluginManager, &PluginManager::sPopulatePlugin, this, &MainWindow::populatePlugin);

    // Sort sample list.
    connect(mPluginManager, &PluginManager::sSortPlugin, this, &MainWindow::sortSampleList);

    // Remove plug-in from the list.
    connect(mPluginManager, &PluginManager::sRemovePlugin, this, &MainWindow::removePlugin);
